...
import { addReadListToLocalDB, addWishListToLocalDB, getAllReadListFromLocalDB, getAllWisListFromLocalDB } from '../utils/LocalDB';

const BookProvider = ({ children }) => {

    const [storedBooks, setStoredBooks] = useState(() => getAllReadListFromLocalDB());

    const [wishListBooks, setWishListBooks] = useState(() => getAllWisListFromLocalDB());
